...
CREATE INDEX Index258dbad759e9fca1fb0719d797856dbd0851e4c3 on Заказ (Менеджер); 
 ...
 ALTER TABLE Товары ADD CONSTRAINT FKc826b94aa75e068cd7abcb7f6b0fe3f89f404bd9 FOREIGN KEY (Товар) REFERENCES Товар; 
CREATE INDEX Indexc826b94aa75e068cd7abcb7f6b0fe3f89f404bd9 on Товары (Товар); 
...
CREATE INDEX Index5b29fefc7c219868aa7d28ddd40530a59eabd7f4 on Товары (Заказ); 
 ...
 ALTER TABLE СостояниеЗаказа ADD CONSTRAINT FKbc6f19686f4cceb4f00152eb1f5da429a8097b51 FOREIGN KEY (Заказ) REFERENCES Заказ; 
CREATE INDEX Indexbc6f19686f4cceb4f00152eb1f5da429a8097b51 on СостояниеЗаказа (Заказ); 
